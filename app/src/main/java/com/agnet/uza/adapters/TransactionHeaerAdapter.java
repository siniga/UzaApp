 ...
 */
public class TransactionHeaerAdapter extends RecyclerView.Adapter<TransactionHeaerAdapter.ViewHolder > {
    ...
    public TransactionHeaerAdapter(Context c, List<ChildTransaction> transactions) {
    ...
    @Override
    public TransactionHeaerAdapter.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                                 int viewType) {
        // create a new view
    ...
    @Override
    public void onBindViewHolder(final TransactionHeaerAdapter.ViewHolder holder, final int position) {
