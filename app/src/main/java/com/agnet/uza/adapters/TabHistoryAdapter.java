 ...
 */
public class TabHistoryAdapter extends RecyclerView.Adapter<TabHistoryAdapter.ViewHolder> {
    ...
    public TabHistoryAdapter(Context c, List<HistoryProduct> products) {
