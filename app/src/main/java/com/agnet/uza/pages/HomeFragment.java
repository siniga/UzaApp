...
public class HomeFragment extends Fragment implements View.OnClickListener {
    ...
    private ImageButton _openInventoryBtn;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.hm_fragment_home, container, false);
        _c = getActivity();
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.category_btn:
                new FragmentHelper(_c).replaceWithbackStack(new CategoryFilterFragment(), "CategoryFragment", R.id.fragment_placeholder);
                break;
            ...
            case R.id.open_product_inventory_btn:
                new FragmentHelper(_c).replaceWithbackStack(new NewInvProductFragment(), "NewInvProductFragment", R.id.fragment_placeholder);
                break;
            default:
                break;
        }
